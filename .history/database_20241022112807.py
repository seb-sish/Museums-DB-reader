...
class Museums:
    def __init__(self, path:str = "db.json", create_new:bool = False):
        self.path = path
    ...
    def create_new(self):
        with open(self.path, "w", encoding="UTF-8") as file:
            ...
            "address": self.table.item(row_index, 1).text(),
            "date": self.table.item(row_index, 2).text(),
            "description": self.table.item(row_index, 3).text(),
            "exposition": self.table.item(row_index, 4).text()
        }
